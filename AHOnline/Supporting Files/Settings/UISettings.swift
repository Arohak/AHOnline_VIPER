...
let FONT_NAVBAR                         = UIFont.systemFont(ofSize: DeviceType.IS_IPAD ? 25 : 18)
let FONT_TABBAR                         = UIFont.systemFont(ofSize: DeviceType.IS_IPAD ? 14 : 10)
let LIMIT                               = 10
let OFFSET                              = 0
...
let DESC_FONT                           = UIFont.boldSystemFont(ofSize: DeviceType.IS_IPAD ? 12       * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 12     : DeviceType.IS_IPHONE_6 ? 12   * IPHONE_6_SCALE : 12   * IPHONE_5_SCALE)
let LINK_FONT                           = UIFont.systemFont(ofSize: DeviceType.IS_IPAD ? 14           * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 14     : DeviceType.IS_IPHONE_6 ? 14   * IPHONE_6_SCALE : 14   * IPHONE_5_SCALE)
